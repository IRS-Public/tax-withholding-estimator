...
class CreditSpec extends AnyFunSuite with TableDrivenPropertyChecks {
  ...
  test("test CDCC: derives and phaseouts correctly with varying AGI, qualifying persons and qualifying expenses") {
    val dataTable = Table(
      ...
      (single, 1, "3000", "30000", "35000", "0", "1260"),
      (single, 2, "6500", "42000", "55000", "0", "2160"),
      (single, 2, "5000", "45000", "50000", "0", "1750"),
      (single, 1, "3000", "45000", "52500", "0", "1050"),
      (single, 2, "1000", "45000", "50000", "0", "350"),
      (single, 3, "30000", "26000", "35000", "0", "993"),
      (single, 1, "1000", "35500", "40000", "0", "390"),
      (single, 1, "15000", "41500", "55000", "0", "1080"),
      (single, 3, "30000", "50000", "57000", "0", "2100"),
      (single, 1, "30000", "75000", "82900", "0", "1050"),
      (single, 3, "10000", "100000", "105000", "0", "1320"),
      ...
      (single, 1, "3000", "110000", "110000", "0", "600"),
      (single, 2, "6000", "250000", "200000", "0", "1200"),
      ...
      (mfs, 1, "3000", "30000", "35000", "0", "1260"),
      (mfs, 2, "6500", "42000", "55000", "0", "2160"),
      (mfs, 2, "5000", "45000", "50000", "0", "1750"),
      (mfs, 1, "3000", "45000", "52500", "0", "1050"),
      (mfs, 2, "1000", "45000", "50000", "0", "350"),
      (mfs, 3, "30000", "26000", "35000", "0", "993"),
      (mfs, 1, "1000", "35500", "40000", "0", "390"),
      (mfs, 1, "15000", "41500", "55000", "0", "1080"),
      (mfs, 3, "30000", "50000", "57000", "0", "2100"),
      (mfs, 1, "30000", "75000", "82900", "0", "1050"),
      (mfs, 3, "10000", "100000", "105000", "0", "1320"),
      ...
      (mfj, 2, "5000", "45000", "50000", "60000", "1283"),
      (mfj, 1, "3000", "45000", "52500", "60000", "1050"),
      (mfj, 2, "1000", "45000", "50000", "60000", "350"),
      (mfj, 3, "30000", "26000", "35000", "60000", "0"),
      (mfj, 1, "1000", "35500", "40000", "60000", "333"),
      (mfj, 1, "15000", "41500", "55000", "60000", "933"),
      (mfj, 3, "30000", "50000", "57000", "60000", "1783"),
      (mfj, 1, "30000", "75000", "82900", "83000", "1050"),
      (mfj, 3, "10000", "100000", "105000", "0", "0"),
      (mfj, 1, "2000", "125000", "129000", "0", "0"),
      (mfj, 2, "30000", "150000", "160000", "160000", "2100"),
      (mfj, 1, "30000", "175000", "185000", "190000", "840"),
      (mfj, 2, "30000", "200000", "205000", "210000", "1320"),
      (mfj, 1, "3000", "215000", "150000", "150000", "600"),
      (mfj, 2, "10000", "400000", "250000", "250000", "1200"),
    )
    forAll(dataTable) {
      (
          status,
  ...
  test("test adoption credit: applies refundability and thresholds correctly") {
    val dataTable = Table(
      ...
      ("279190", "20000", 1, "5120", "6312.49"),
      ("279190", "10000", 1, "5120", "1350"),
      ("289190", "40000", 2, "5120", "8909.98"),
      ("298000", "20000", 1, "3127.59", "0"),
      ("299190", "20000", 1, "2597.49", "0"),
      ("305081", "20000", 1, "0", "0"),
    )
