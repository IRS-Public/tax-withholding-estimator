...
class CreditSpec extends AnyFunSuite with TableDrivenPropertyChecks {
  ...
  test("test adoption credit: applies refundability and thresholds correctly") {
    val dataTable = Table(
      ...
      ("100000", "0", 1, "0", "0"),
      ("100000", "10000", 0, "0", "0"),
      ("100000", "17280", 1, "5000", "7643"),
      ("150000", "20000", 1, "5000", "12280"),
      ("150000", "4000", 1, "4000", "0"),
      ("150000", "6000", 1, "5000", "1000"),
      ("150000", "30000", 2, "5000", "15340"),
      ("150000", "40000", 2, "5000", "15340"),
      ("250000", "100000", 3, "5000", "37468"),
      ("265080", "20000", 1, "5000", "9739.84"),
      ("279190", "20000", 1, "5000", "3640"),
      ("279190", "10000", 1, "5000", "0"),
      ("289190", "40000", 2, "5000", "3640"),
      ("298000", "20000", 1, "518.4", "0"),
      ("299190", "20000", 1, "0", "0"),
      ("305081", "20000", 1, "0", "0"),
    )
