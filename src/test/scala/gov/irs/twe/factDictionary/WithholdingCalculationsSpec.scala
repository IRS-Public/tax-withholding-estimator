...
class WithholdingCalculationsSpec extends AnyFunSuite with TableDrivenPropertyChecks {
  ...
  val dataTable = Table(
    ...
    // We are intentionally ignoring these edge cases because the results are due to stacking assumptions that may not be accurate and add complexity
    // (semiMonthly, "2025-01-31", "2025-01-31", 0),
    // (semiMonthly, "2025-01-30", "2025-01-30", 0),
    (semiMonthly, "2025-02-13", "2025-01-31", 2),
    (semiMonthly, "2025-02-14", "2025-02-01", 2),
    (semiMonthly, "2025-02-14", "2025-02-01", 2),
    (monthly, "2025-05-20", "2025-05-05", 0),
    (monthly, "2025-05-21", "2025-05-05", 1),
    (monthly, "2025-06-04", "2025-05-05", 1),
    (monthly, "2025-02-12", "2025-01-31", 0),
    (monthly, "2025-02-13", "2025-01-31", 1),
  )
